...
def main():
    ...
    target = test_df['diagnosis'].values
    ...
    recl = recall_score(target, preds, average='micro')
    f1 = f1_score(target, preds, average='micro')
    pre = precision_score(target, preds, average='micro')
    #auc = auc(target, preds)
